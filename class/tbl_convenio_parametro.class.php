...
class Tbl_convenio_parametro{

	private $PK_Convenio_Parametro = 0;
	...
	private $Type = "";
	private $Method = "";
	private $KeyField = "PK_Convenio_Parametro";
	private $Engine = "InnoDB";

	public function setPK_Convenio_Parametro($PK_Convenio_Parametro){
		$this->PK_Convenio_Parametro = intval($PK_Convenio_Parametro);
	}
	...
	public function getPK_Convenio_Parametro(){
		return intval($this->PK_Convenio_Parametro);
	}
